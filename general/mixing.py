...
class mixing(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "mixing")
        ...
        self.freq2 = freq2 = 1000
        self.freq1 = freq1 = 1000
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, freq2, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0, 0), (self.steves_utils_mixer_0, 0))
        self.connect((self.analog_sig_source_x_0_0, 0), (self.qtgui_time_sink_x_1, 0))
        self.connect((self.analog_sig_source_x_0_0, 0), (self.steves_utils_mixer_0, 1))
        self.connect((self.blocks_throttle_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.qtgui_time_sink_x_1_0, 0))
        self.connect((self.steves_utils_mixer_0, 0), (self.blocks_throttle_0, 0))
...
def main(top_block_cls=mixing, options=None):
