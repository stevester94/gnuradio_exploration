...
# Title: Top Block
# Generated: Tue Nov 16 21:25:44 2021
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.tone_freq = tone_freq = 5000
        self.samp_rate = samp_rate = 44100

        ##################################################
        # Blocks
        ##################################################
        self._tone_freq_range = Range(0, 20000, 1000, 5000, 200)
        self._tone_freq_win = RangeWidget(self._tone_freq_range, self.set_tone_freq, "tone_freq", "counter_slider", int)
        ...
        self.low_pass_filter_0_0 = filter.fir_filter_ccf(1, firdes.low_pass(
        	1, samp_rate, 5000, 2000, firdes.WIN_HAMMING, 6.76))
        self.blocks_wavfile_source_0 = blocks.wavfile_source("/home/steven/gnuradio_exploration/mozart.wav", True)
        self.blocks_multiply_const_vxx_0_0 = blocks.multiply_const_vff((1, ))
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_vcc((1, ))
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.audio_sink_0 = audio.sink(samp_rate, "", True)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, tone_freq, 0.05, 0)
        self.analog_frequency_modulator_fc_0 = analog.frequency_modulator_fc(0.6545)
        self.analog_fm_preemph_0 = analog.fm_preemph(fs=samp_rate, tau=75e-6)
        ...
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.analog_fm_demod_cf_0, 0))    
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.samp_rate, 5000, 2000, firdes.WIN_HAMMING, 6.76))
